...
foreach($months as $key=>$value){
    ...
    echo '<table>';
    echo '<tr><th>M</th><th>D</th><th>W</th><th>D</th><th>V</th><th>Z</th><th>Z</th><th class="weeknumber">W#</th></tr><tr>';
    ...
    foreach($days as $day)
    {
        $dayTimeStamp= mktime(0,0,0,$key,$day,$year);
        ...
        if($weekday == 0)
        {
            echo '<td class="weeknumber">'.date('W', mktime(0,0,0,$key,$day,$year)).'</td>';
            echo '</tr>';
        }    
    }
